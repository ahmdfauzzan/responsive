    ...
    <div>
      ...
      <div className="m-5 h-[85vh] flex-col flex mobile:flex-col tablet:flex-col web:flex">
        <div className="flex w-full h-full flex-col mobile:flex-col tablet:flex-col-reverse web:flex-row">
          <div className="mb-3 h-[50%] mobile:h-[50%] tablet:h-[50%] web:h-[100%] web:w-[50%]">
            <div className="bg-purple-500 h-full m-2 flex justify-center items-center text-3xl">ungu</div>
          </div>

          <div className="h-[100%] w-full mr-3 flex flex-col-reverse mobile:flex-col-reverse tablet:flex-col web:flex-col">
            <div className="bg-green-500 flex-col-reverse h-[50%] w-full m-2 flex justify-center items-center text-3xl">hijau</div>

            <div className="h-[50%] flex mb-3 flex-row-reverse mobile:flex-row-reverse tablet:flex-row web:flex-row">
